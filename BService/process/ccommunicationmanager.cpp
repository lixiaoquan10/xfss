...
void CCommunicationManager::handleLinkageReciveData()
{
    ...
    if(pSerialPort)
    {
        ...
        else
        {
            ...
            QFile file("/home/xfss/root/FasReciveData.txt");
            ...
            QString filePath = "/home/xfss/root/FasReciveData.txt";
...
void CCommunicationManager::handleTestReciveData()
{
    ...
    if(pSerialPort)
    {
           ...
           static_cast<unsigned char>(receiveData.at(4)) == 0xFF)
        {
            ...
            QFile fileReceive("/home/xfss/root/FasTestData.txt");
            ...
            QFile fileSend("/home/xfss/root/FasTestData.txt");

    ...
    if(!m_communicationManager->isSerialportNameSeted())
    {
        ...
        if(communicationIsActive(communicationLinkage))
        {
            ...
            if(pSerialPort)
            {
                ...
                QFile file("/home/xfss/root/LedLinkageData.txt");
...
void CCommunicationRoute::testLinkageCom()
{
    ...
    if(communicationIsActive(communicationLinkage))
    {
        ...
        if(pSerialPort_test && pSerialPort_linkage)
        {
            ...
            QFile file("/home/xfss/root/FasTestData.txt");
...
//        m_communicationManager->sendLinkageData(communicationLinkage, SendFasFire, data);
        if(pSerialPort)
        {
            ...
            QString  data = "FasSendData:  " + byteArray.toHex() + "   " + QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
            QFile file("/home/xfss/root/FasSendData.txt");
            ...
            QString filePath = "/home/xfss/root/FasSendData.txt";

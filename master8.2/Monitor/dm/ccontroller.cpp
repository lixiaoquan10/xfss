...
=======
void CController::paramInit(QSqlDatabase db)
{
    qDebug() << "CController::paramInit"
             << QDateTime::currentDateTime().toString("HH:mm:ss:zzz");
    QSqlQuery query(db);
    query.prepare(QString("SELECT ParamName,ParamValue FROM ParamInfo"));
    if (!query.exec())
    {
        qDebug() << "paramInit Error:" << query.lastError().text();
        return;
    }
...
<<<<<<< HEAD
        ...
        else if(query.value(fieldParamName).toString() == "EmergencyAfterDirection")
        {
            CGlobal::instance()->m_emergencyAfterDirection = query.value(fieldParamValue).toBool();
=======
...
=======
        ...
        else if(query.value(fieldParamName).toString() == "MQTTTopic")
        {
            CGlobal::instance()->m_mqttTopic = query.value(fieldParamValue).toString();
        }
...
=======
int CController::loadController(QSqlDatabase db, CDM *dm)
>>>>>>> 341c9929318cff5b207944113ce95e985e86616c
{
...
=======
int CController::saveController(QSqlDatabase db)
>>>>>>> 341c9929318cff5b207944113ce95e985e86616c
{
...
=======
int CController::saveCanport(QSqlDatabase db)
>>>>>>> 341c9929318cff5b207944113ce95e985e86616c
{

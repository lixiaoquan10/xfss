    ...
    ui(new Ui::dlgTimeInterval)
{
    ...
    QButtonGroup *lampEmergencyTypeGroup = new QButtonGroup(this);
    lampEmergencyTypeGroup->addButton(ui->DirectionTwinkleOneCheckBox);
    lampEmergencyTypeGroup->addButton(ui->DirectionTwinkleDoubleCheckBox);
    lampEmergencyTypeGroup->addButton(ui->TwinkleConfigCheckBox);
    lampEmergencyTypeGroup->setExclusive(true);

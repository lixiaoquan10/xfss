    ...
    QWidget(parent), ui(new Ui::CProgramDeviceView)
{
    ...
    ui->tableView->setColumnWidth(DEVICE_COLUMN_PRODUCTID, 145);
    ui->tableView->setColumnWidth(DEVICE_COLUMN_VERSION, 90);
...
//    ui->tableView->setColumnWidth(DEVICE_COLUMN_LOCATION, 32);
    ui->tableView->setColumnWidth(DEVICE_COLUMN_STATUS, 65);
